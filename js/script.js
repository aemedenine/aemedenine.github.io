...
      // ❌ قبل: userBox مخفي
      // ✅ بعد: خلي userBox ظاهر و زر login يختفي
      if(userBox) userBox.style.display = "flex";
      if(loginButton) loginButton.style.display = "none";
      // حط صورة الحساب واسم المستخدم
...
  e.stopPropagation();
  auth.signOut().then(() => {
    userBox.style.display = "none"; // اخفي صندوق المستخدم
    loginButton.style.display = "inline-block"; // ارجع زر login
    alert("🔓 Déconnecté !");
  });
});
...
  currentUser = user;
  if (user) {
    // ✅ خلي userBox ظاهر و زر login يختفي
    if(userBox) userBox.style.display = "flex";
    if(loginButton) loginButton.style.display = "none";
    // حط صورة الحساب واسم المستخدم
    const avatar = document.getElementById("userAvatar");
